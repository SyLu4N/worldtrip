...
export const citys: CitysProps = {
  ...
  americadoNorte: {
    summary: {
      ...
      text: 'A América do Norte está localizada no extremo norte das Américas e écomposta por apenas quatro países: Estados Unidos, Canadá, Dinamarca e por ultimo o México. Os dois primeiros países são os únicos do continente americano que estão inseridos no grupo dos países mais importantes político e economicamente.',
      citys: '7',
      country: '4',
      languages: '5',
    },
